...
<body>
	...
	<table border='1' cellpadding='5' cellspacing='0' width='400'>
		<tr bgcolor='#CCCCFF' align='center' valign='center' height='20'>
			<td><h3>Cricket's IPL League: List League</h3></td>
		</tr>
	</table>

	<p>This is the List for Cricket League</p>

	<h3>Players</h3>

	<div style="color: black;">
		<table>
			<c:forEach items="${leagues}" var="leagues">
				<li>${leagues}</li>
			</c:forEach>
		</table>
	</div>
	<a href="/addleague" type="button" class="btn btn-outline-info">Add
		League</a>
